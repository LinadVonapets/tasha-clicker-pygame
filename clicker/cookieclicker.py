...
class Item:
    ...
    def draw(self, surface):
        ...
        #draw text
        text_surface = FONT.render(str(self.count) + "x" + self.text + " $" + str(int(self.price())), True, BLACK)
...
cookie_rect = COOKIE_IMAGE.get_rect(topleft=(100, 150))
...
while True:
    ...
    #draw cookies count
    text_surface = FONT.render(str(int(COOKIES)) + "+" + str(CPS) + "CPS", True, BLACK)
    text_rect = text_surface.get_rect()
    text_rect.topleft = (165, 100)
